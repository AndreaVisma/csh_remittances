...
df_gdp = pd.read_excel("c:\\data\\economic\\gdp\\gdp_per_capita_to_2024.xls", sheet_name= 'Data', skiprows=3)
df_gdp.drop(columns = ["Country Code", "Indicator Name", "Indicator Code"], inplace = True)

df_gdp = pd.melt(df_gdp, id_vars='Country Name', value_vars=df_gdp.columns.tolist()[1:],
...
df_gdp = df_gdp[(df_gdp.year >2009) & (df_gdp.year <= 2025)]
df_gdp = df_gdp[~df_gdp.country.isna()]
...
result_gdp.to_pickle("c:\\data\\economic\\gdp\\annual_gdp_per_capita_splined_2010_to_2024.pkl")
...
df_pairs.to_pickle("c:\\data\\economic\\gdp\\annual_gdp_deltas_2010to_2024.pkl")